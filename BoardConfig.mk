...
#
TARGET_BOOTLOADER_BOARD_NAME := elite10
...
TARGET_CUSTOM_RELEASETOOL := ./device/allwinner/elite/releasetools/squisher

BOARD_HAVE_BLUETOOTH := true
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/allwinner/elite/vibrator.c
...
#EGL stuff
BOARD_EGL_CFG := device/allwinner/elite/egl.cfg
...
TARGET_KERNEL_MODULES_EXT := $(ANDROID_BUILD_TOP)/device/allwinner/elite/prebuilt/lib/modules
BOARD_KERNEL_CMDLINE := console=ttyS0,115200 rw init=/init
BOARD_KERNEL_BASE := 0x40000000
BOARD_KERNEL_PAGESIZE := 2048

# Beware: set only prebuilt OR source+config
TARGET_PREBUILT_KERNEL := $(ANDROID_BUILD_TOP)/device/allwinner/elite/kernel
