...
device_path = device/allwinner/elite

DEVICE_PREBUILT := ${device_path}/prebuilt

# Ramdisk
PRODUCT_COPY_FILES += \
	device/allwinner/a10/roor/init.sun4i.rc:root/init.sun4i.rc \
	device/allwinner/a10/root/init.sun4i.usb.rc:root/init.sun4i.usb.rc \
	device/allwinner/a10/root/ueventd.rc:root/ueventd.rc \
	device/allwinner/a10/root/ueventd.sun4i.rc:root/ueventd.sun4i.rc \
	device/allwinner/a10/root/adbd:root/sbin/adbd \
